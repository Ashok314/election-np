...
const CONSTITUENCIES: Array<{ distId: number; consts: number }> = [
  { distId: 1, consts: 1 }, { distId: 2, consts: 1 }, { distId: 3, consts: 2 },
  { distId: 4, consts: 5 }, { distId: 5, consts: 1 }, { distId: 6, consts: 1 },
  { distId: 7, consts: 1 }, { distId: 8, consts: 1 }, { distId: 9, consts: 6 },
  { distId: 10, consts: 4 }, { distId: 11, consts: 1 }, { distId: 12, consts: 1 },
  { distId: 13, consts: 1 }, { distId: 14, consts: 2 }, { distId: 15, consts: 4 },
  { distId: 16, consts: 4 }, { distId: 17, consts: 1 }, { distId: 18, consts: 1 },
  { distId: 19, consts: 2 }, { distId: 20, consts: 4 }, { distId: 21, consts: 4 },
  { distId: 22, consts: 4 }, { distId: 23, consts: 1 }, { distId: 24, consts: 2 },
  { distId: 25, consts: 2 }, { distId: 26, consts: 10 }, { distId: 27, consts: 2 },
  { distId: 28, consts: 3 }, { distId: 29, consts: 2 }, { distId: 30, consts: 2 },
  { distId: 31, consts: 2 }, { distId: 32, consts: 4 }, { distId: 33, consts: 4 },
  { distId: 34, consts: 4 }, { distId: 35, consts: 3 }, { distId: 36, consts: 2 },
  { distId: 37, consts: 1 }, { distId: 38, consts: 1 }, { distId: 39, consts: 3 },
  { distId: 40, consts: 2 }, { distId: 41, consts: 2 }, { distId: 42, consts: 2 },
  { distId: 43, consts: 2 }, { distId: 44, consts: 1 }, { distId: 45, consts: 2 },
  { distId: 46, consts: 5 }, { distId: 47, consts: 3 }, { distId: 48, consts: 1 },
  { distId: 49, consts: 1 }, { distId: 50, consts: 2 }, { distId: 51, consts: 1 },
  { distId: 52, consts: 1 }, { distId: 53, consts: 1 }, { distId: 54, consts: 1 },
  { distId: 55, consts: 1 }, { distId: 56, consts: 3 }, { distId: 57, consts: 1 },
  { distId: 58, consts: 1 }, { distId: 59, consts: 1 }, { distId: 60, consts: 1 },
  { distId: 61, consts: 1 }, { distId: 62, consts: 1 }, { distId: 63, consts: 2 },
  { distId: 64, consts: 2 }, { distId: 65, consts: 3 }, { distId: 66, consts: 2 },
  { distId: 67, consts: 1 }, { distId: 68, consts: 2 }, { distId: 69, consts: 1 },
  { distId: 70, consts: 1 }, { distId: 71, consts: 5 }, { distId: 72, consts: 1 },
  { distId: 73, consts: 1 }, { distId: 74, consts: 1 }, { distId: 75, consts: 3 },
  { distId: 77, consts: 2 }, { distId: 78, consts: 1 }
];
...
Deno.serve(async (_req: Request) => {
  try {
    ...
    console.log(`[scrape-ecn] Fetched ${fetched} seats, ${failed} failed. Upserting ${rows.length} candidate rows...`);
